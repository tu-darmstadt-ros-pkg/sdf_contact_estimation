...
namespace timing {
  ...
  #ifndef NO_TIMING
    #define START_TIMING(timerName) timing::Timing::startTiming(timerName);

    #define STOP_TIMING timing::Timing::stopTiming(false);

    #define STOP_TIMING_PRINT timing::Timing::stopTiming(true);
  ...
  inline std::string line(int length) {
    std::string l = "";
